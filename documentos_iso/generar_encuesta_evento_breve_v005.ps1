...
$output = Join-Path $baseDir "SS-ENCUESTA-BREVE-EVENTO-AGUAS-ABIERTAS-V005-SIN-PRECIO.docx"
...
[void]$body.Append((P "Lo que mas condiciona mi respuesta es: [ ] comodidad [ ] tamano/peso [ ] sujecion [ ] privacidad [ ] falsas alertas [ ] mantenimiento/servicio"))

[void]$body.Append((Question "7. Que modelo te resultaria mas claro para un producto asi?"))
[void]$body.Append((P "[ ] Comprar dispositivo y pagar servicio activo   [ ] Alquiler por temporada/evento"))
[void]$body.Append((P "[ ] Plan de club/equipo   [ ] Solo lo usaria si lo ofrece el organizador   [ ] No lo usaria"))

[void]$body.Append((Question "8. Que deberia incluir el servicio para que tenga sentido mantenerlo activo? Marca hasta 3."))
[void]$body.Append((P "[ ] Contacto familiar activo   [ ] Ubicacion/ultima senal   [ ] Alerta por salida de zona"))
[void]$body.Append((P "[ ] Historial de sesiones   [ ] Reporte tecnico   [ ] Soporte/reposicion   [ ] Cobertura en eventos"))

[void]$body.Append((Question "9. Quien deberia recibir una alerta en una sesion normal?"))
...
[void]$body.Append((Question "10. En una frase: que tendria que lograr Save Swimmer para que lo recomiendes?"))
...
<w:styles xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:style w:type="paragraph" w:default="1" w:styleId="Normal">
    ...
    <w:pPr><w:spacing w:after="38" w:line="205" w:lineRule="auto"/></w:pPr>
  </w:style>
