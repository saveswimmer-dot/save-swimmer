...
$frontPath = Join-Path $baseDir "SS-TARJETA-PRESENTACION-FRENTE-V002.png"
$backPath = Join-Path $baseDir "SS-TARJETA-PRESENTACION-DORSO-V002.png"
...
$g.DrawString("TECNOLOGIA DE SEGURIDAD ACUATICA", (FontC 24 ([System.Drawing.FontStyle]::Bold)), (BrushC $orange), 88, 444)
$g.DrawString("Monitoreo, ubicacion y contexto para natacion en aguas abiertas.", (FontC 25), (BrushC $muted), 88, 486)
...
$g.DrawString("Founder / Desarrollo Save Swimmer", (FontC 30 ([System.Drawing.FontStyle]::Bold)), (BrushC $cyan), 88, 164)
$g.DrawString("Seguridad conectada, monitoreo y datos aplicados", (FontC 23), (BrushC $muted), 88, 218)
$g.DrawString("a nadadores de aguas abiertas.", (FontC 23), (BrushC $muted), 88, 248)
