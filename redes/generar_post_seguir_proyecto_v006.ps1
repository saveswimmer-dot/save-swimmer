...
$outPath = Join-Path $baseDir "SS-POST-SEGUIR-PROYECTO-V006.png"
$copyPath = Join-Path $baseDir "SS-POST-SEGUIR-PROYECTO-COPY-V006.txt"
...
FillRound $g (BrushA "#082633" 245) 58 880 964 136 16
DrawRound $g (PenA "#1B6070" 230 2) 58 880 964 136 16
DrawText $g "HACIA DONDE VAMOS" 25 $white 88 902 ([System.Drawing.FontStyle]::Bold)
$g.DrawLine((PenC $cyan 4), 88, 942, 330, 942)
DrawText $g "alerta temprana + ubicaci{o_}n + contexto del nado" 27 $cyan 88 955 ([System.Drawing.FontStyle]::Bold)
DrawText $g "Seguinos, opin{a_} y aport{a_} si pod{e_}s." 20 $muted 88 992
DrawText $g "Cada prueba acerca el dispositivo al agua." 20 $muted 88 1016
