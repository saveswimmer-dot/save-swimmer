...
$outPath = Join-Path $baseDir "SS-POST-SEGUIR-PROYECTO-V005.png"
$copyPath = Join-Path $baseDir "SS-POST-SEGUIR-PROYECTO-COPY-V005.txt"
...
DrawText $g "PROTOTIPO REAL EN DESARROLLO" 22 $cyan 84 676 ([System.Drawing.FontStyle]::Bold)
DrawText $g "Estamos ordenando hardware, midiendo energia, registrando GPS y preparando pruebas en agua." 20 $white 84 704
...
FillRound $g (BrushA "#082633" 245) 58 882 964 120 16
DrawRound $g (PenA "#1B6070" 230 2) 58 882 964 120 16
DrawText $g "HACIA DONDE VAMOS" 25 $white 88 906 ([System.Drawing.FontStyle]::Bold)
$g.DrawLine((PenC $cyan 4), 88, 946, 330, 946)
DrawText $g "alerta temprana + ubicacion + contexto del nado" 28 $cyan 88 960 ([System.Drawing.FontStyle]::Bold)
DrawText $g "Seguinos, opin{a_} y aport{a_} si pod{e_}s. Cada prueba acerca el dispositivo al agua." 20 $muted 88 996

DrawText $g "@saveswimmer" 24 $cyan 60 1030 ([System.Drawing.FontStyle]::Bold)
DrawText $g "saveswimmer@gmail.com" 22 $white 770 1032 ([System.Drawing.FontStyle]::Bold)
...
Estamos desarrollando en Peru un dispositivo dorsal de seguridad para nadadores de aguas abiertas.
...
Ahora seguimos avanzando hacia pruebas en agua para validar lo mas importante: ubicacion, movimiento, zona segura y alertas tempranas.

Si nadas, entrenas, organizas eventos o tienes familia que nada en aguas abiertas, nos ayuda mucho que sigas el proyecto, comentes que informacion te seria util y compartas la publicacion.

Tambien puedes apoyar el desarrollo desde StartFund:
