...
$outPath = Join-Path $baseDir "SS-POST-TELEMETRIA-EN-VIVO-V009.png"
$copyPath = Join-Path $baseDir "SS-POST-TELEMETRIA-EN-VIVO-COPY-V009.txt"
...
DrawText $g "TELEMETR{I_}A" 82 $white 154 50 ([System.Drawing.FontStyle]::Bold)
DrawText $g "EN VIVO" 82 $cyan 800 50 ([System.Drawing.FontStyle]::Bold)
...
DrawText $g "MAYOR SEGURIDAD." 23 $cyan 440 992 ([System.Drawing.FontStyle]::Bold)
DrawText $g "M{A_}S CONEXI{O_}N." 23 $cyan 680 992 ([System.Drawing.FontStyle]::Bold)
DrawText $g "MEJOR ACOMPA{N_}AMIENTO." 23 "#A8BBC2" 895 992 ([System.Drawing.FontStyle]::Bold)
DrawText $g "Probamos hoy para proteger ma{n_}ana." 20 $white 1240 985 ([System.Drawing.FontStyle]::Bold)
DrawText $g "Save Swimmer" 21 $cyan 1240 1010 ([System.Drawing.FontStyle]::Bold)
