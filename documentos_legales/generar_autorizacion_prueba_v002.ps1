...
$base = Join-Path $PSScriptRoot "_docx_tmp_autorizacion_v002"
$output = Join-Path $PSScriptRoot "SS-FRM-CONFIDENCIALIDAD-AUTORIZACION-PRUEBA-V002.docx"
...
Add-Table @(
    @("Codigo", "SS-FRM-PRUEBA-DATOS-001", "Version", "V002"),
    @("Fecha de emision", "05/06/2026", "Estado", "Borrador operativo para prueba piloto"),
    @("Proyecto", "Save Swimmer - prototipo actual", "Responsable", "Victor Loza"),
...
Add-Table @(
    @("Proyecto / Responsable", "Save Swimmer - Victor Loza"),
...
Add-Paragraph "Alcance actualizado al 05/06/2026: el prototipo actual puede registrar telemetria de movimiento, guardar sesiones localmente, comunicarse por BLE con una aplicacion movil y, cuando se habilita expresamente, utilizar GPS y datos moviles de un telefono gateway para pruebas de ubicacion y transmision. Estas funciones siguen en validacion y pueden fallar o interrumpirse." "Normal"
...
Add-Table @(
    ...
    @("Nombre: _______________________________", "Nombre: Victor Loza"),
...
Add-Table @(
    ...
    @("V002", "05/06/2026", "Actualizacion de responsable, version y alcance del prototipo actual para posibles pruebas piloto.", "Save Swimmer / Victor Loza"),
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:p>
    ...
    <w:r><w:rPr><w:sz w:val="17"/><w:color w:val="6A8790"/></w:rPr><w:t>Save Swimmer | SS-FRM-PRUEBA-DATOS-001 | V002 | Documento confidencial de prototipo</w:t></w:r>
  </w:p>
</w:ftr>
'@
