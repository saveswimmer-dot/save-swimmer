...
$outPath = Join-Path $baseDir "SS-CARTA-SOLICITUD-PRUEBA-PISCINA-V002.docx"
$tmpRoot = Join-Path $baseDir "_tmp_docx_piscina_v002"
...
$body += P "Documento: SS-CARTA-SOLICITUD-PRUEBA-PISCINA-V002"
$body += P "Versión: V002"
